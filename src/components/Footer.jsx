  ...
  return (
    <div>
      <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-4 fixed bottom-0">
        ...
        <nav className="grid grid-flow-col gap-3 text-sm">
        ...
        <nav>
          <div className="grid grid-flow-col gap-3">
            ...
            <a>
              ...
              >
                <path
                  d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4
        ...
        <aside>
          <p className="text-xs">
            Copyright © {new Date().getFullYear()} - All right reserved by DevTinder Ltd
          </p>
        </aside>
